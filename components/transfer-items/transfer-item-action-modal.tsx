...
interface TransferItemActionModalProps {
  open: boolean;
...
export function TransferItemActionModal({
  open,
  onOpenChange,
  action,
  item,
  onSuccess,
}: TransferItemActionModalProps) {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/transfer-items/${item.id}`, {
        method,
        headers:
