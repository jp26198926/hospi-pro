...
interface PharConversionViewModalProps {
  open: boolean;
...
interface PharConversionCancelModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  conversion: Conversion | null;
  onSuccess: () => void;
...
export function PharConversionViewModal({
  open,
  onOpenChange,
  conversion,
  timezone,
  appSettings,
}: PharConversionViewModalProps) {
...
export function PharConversionCancelModal({
  open,
  onOpenChange,
  conversion,
  onSuccess,
}: PharConversionCancelModalProps) {
  ...
  const handleConfirm = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`/api/phar-conversions/${conversion.id}`, {
        method: "DELETE",
      ...
      >
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-4">
          <p className="text-sm text-[#333]">
            ...
            ? Stock will be reversed for both products at pharmacy.
          </p>
