...
import {
  getReceivingItemColumns,
  ReceivingItem,
} from "./receiving-items-columns";
import { ReceivingItemFormModal } from "./receiving-item-form-modal";
import { ReceivingItemActionModal } from "./receiving-item-action-modal";
...
export function ReceivingItemsTable({
  ...
  const [actionItem, setActionItem] = useState<ReceivingItem | null>(null);
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/receiving-items?${params}`);
