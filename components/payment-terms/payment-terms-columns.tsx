...
interface ColumnActions {
  onView: (paymentTerm: PaymentTerm) => void;
  onEdit: (paymentTerm: PaymentTerm) => void;
  onDelete: (paymentTerm: PaymentTerm) => void;
  onRestore: (paymentTerm: PaymentTerm) => void;
  timezone: string;
}
...
export function getColumns({
  ...
  onRestore,
  timezone,
}: ColumnActions): ColumnDef<PaymentTerm>[] {
  return [
    {
      accessorKey: "no",
      header: "#",
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span className="font-medium">{row.original.termDays}</span>
      ),
    },
    {
      accessorKey: "status",
