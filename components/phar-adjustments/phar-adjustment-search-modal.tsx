...
interface PharAdjustmentSearchModalProps {
  open: boolean;
...
export function PharAdjustmentSearchModal({
  open,
  onOpenChange,
  onSearch,
  productOptions,
}: PharAdjustmentSearchModalProps) {
  ...
  const handleSearch = () => {
    onSearch(searchTerm, statusFilter, productFilter, dateFrom, dateTo);
    onOpenChange(false);
  };
      ...
      >
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-4">
          <div className="space-y-2">
            ...
            <Input
              placeholder="Search pharmacy adjustments..."
              value={searchTerm}
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              <Label
                htmlFor="phar-adj-date-from"
                className="text-sm font-medium text-[#333]"
              >
                Date From
              </Label>
              <DatePicker
                id="phar-adj-date-from"
                value={dateFrom}
