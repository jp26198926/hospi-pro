import { GstTypesTable } from "@/components/gst-types/gst-types-table";
import { getAppTimezone } from "@/lib/settings";
import { requirePageRead } from "@/lib/api-auth";

export const metadata = {
  title: "GST Types",
  description: "Manage GST types",
};

export default async function GstTypesPage() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-[#337ab7]">GST Types</h1>
      ...
      <div className="rounded-sm border border-[#ddd] bg-white shadow-sm">
        ...
        <div className="p-4">
          <GstTypesTable timezone={timezone} />
        </div>
      </div>
    </div>
  );
