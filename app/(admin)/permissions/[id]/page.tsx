          ...
          <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-sm border border-[#eee] bg-[#fafafa] p-4">
              ...
              <dd className="mt-1 text-sm text-foreground">
                {format(new Date(permission.createdAt), "MMMM dd, yyyy HH:mm:ss")}
              </dd>
            </div>
            <div className="rounded-sm border border-[#eee] bg-[#fafafa] p-4">
              ...
              <dd className="mt-1 text-sm text-foreground">
                {permission.updatedAt
                  ? format(new Date(permission.updatedAt), "MMMM dd, yyyy HH:mm:ss")
                  : "-"}
              </dd>
            </div>
            <div className="rounded-sm border border-[#eee] bg-[#fafafa] p-4">
              ...
              <dd className="mt-1 text-sm text-foreground">
                {permission.deletedAt
                  ? format(new Date(permission.deletedAt), "MMMM dd, yyyy HH:mm:ss")
                  : "-"}
              </dd>
            </div>
          </dl>
